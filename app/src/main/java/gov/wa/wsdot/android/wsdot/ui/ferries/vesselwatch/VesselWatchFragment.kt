...
class VesselWatchFragment: DaggerFragment(), Injectable, OnMapReadyCallback, GoogleMap.OnMarkerClickListener,SpeedDialView.OnActionSelectedListener {
    ...
    fun checkHeading(heading: Float): Pair<Float,Float> {
        return when (heading) {
            in 0F..15F -> Pair(0.5F, -0.75F)
            in 16F..30F -> Pair(0.5F, -0.75F)
            in 31F..45F -> Pair(0.25F, -1.0F)
            in 46F..60F -> Pair(0.25F, -1.25F)
            in 61F..75F -> Pair(0.0F, -1.25F)
            in 76F..90F -> Pair(0.0F, -1.25F)
            in 91F..105F -> Pair(0.0F, -1.5F)
            in 106F..120F -> Pair(0.0F, -1.75F)
            in 121F..145F -> Pair(0.0F, -2.25F)
            in 146F..160F -> Pair(0.25F, -2.5F)
            in 161F..175F -> Pair(0.25F, -2.5F)
            in 176F..190F -> Pair(0.5F, -2.75F)
            in 191F..205F -> Pair(0.75F, -2.5F)
            in 206F..220F -> Pair(0.75F, -2.5F)
            in 221F..245F -> Pair(0.75F, -2.0F)
            in 246F..260F -> Pair(1.0F, -1.75F)
            in 261F..275F -> Pair(1.0F, -1.5F)
            in 276F..290F -> Pair(1.0F, -1.25F)
            in 291F..305F -> Pair(0.75F, -1.25F)
            in 306F..320F -> Pair(0.5F, -1.0F)
            in 321F..345F -> Pair(0.5F, -0.75F)
            in 346F..360F -> Pair(0.5F, -0.75F)
            else -> Pair(0.0F, -1.0F)
        }
    }
